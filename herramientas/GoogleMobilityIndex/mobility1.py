...
for i in regiones:
	...
	values=linea['parks_percent_change_from_baseline']
...
plt.title(r'Reducción Mobilidad (Parques), media móvil 7 días - Google', fontsize=16, fontproperties=prop)
plt.xlabel(r'Fecha', fontsize=14, fontproperties=prop)
plt.ylabel(r'Variación en (%) relativa a base entre 6 de Enero y 3 de Febrero', fontsize=16, fontproperties=prop)

###GLOSA y ETIQUETAS
plt.legend(handles=[pop_a,pop_b,pop_c,pop_d,pop_e,pop_f,pop_g,pop_h], prop = prop)
plt.savefig("outMOBILITYparques.png")
plt.show()