...
def extraerDatosRegiones():
    ...
    if os.path.isfile(path + fechaHoyString + formato_archivo):
        ...
        currentTable = list(table.children)[2]
        ...
        nombres_columnas = [
            "nombre_region", "casos_totales", "casos_nuevos",
            "casos_nuevos_sintomas", "casos_nuevos_nosintomas",
            "fallecidos_totales", "porcentaje_total"
        ]
       ...
       # print(len(list(currentTbody.children)))
        ...
        informeHoy = informeHoy[[
            'id_region', 'nombre_region', 'casos_totales', 'casos_nuevos',
            'casos_nuevos_sintomas', 'casos_nuevos_nosintomas',
            'fallecidos_totales'
        ]]
        ...
        informeHoy.fallecidos_totales = informeHoy.fallecidos_totales.astype(
            int)
        ...
        informeAyer = informeAyer.rename(
            columns={'fallecidos_totales': 'fallecidos_totales_old'})
        informeAyer = informeAyer[['id_region', 'fallecidos_totales_old']]
        informeHoy = pd.merge(informeHoy, informeAyer, on='id_region')
        informeHoy[
            'fallecidos_nuevos'] = informeHoy.fallecidos_totales - informeHoy.fallecidos_totales_old
